...
class Tree(object):
    ...
    def __init__(self, grid_size):
        ...
        self._root_node_name = Tree._ROOT_NODE_NAME

        self._outlier_node_name = Tree._OUTLIER_NODE_NAME
    ...
    def _internal_add_data_point_to_node(self, build_add, data_point: DataPoint, node):
