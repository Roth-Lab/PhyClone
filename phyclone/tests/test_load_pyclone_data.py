...
from phyclone.data.pyclone import _create_raw_data_df, _remove_cn_zero_mutations, _remove_duplicated_and_partially_absent_mutations, _process_required_cols_on_df, _create_loaded_pyclone_data_dict, get_major_cn_prior, load_pyclone_data
import pandas as pd
import os
    ...
    def _assert_datapoint_dict_against_df_dict(self, actual_df, data, df_dict, skip_dict):
        ...
        for mut, dp in data.items():
            ...
            for i, sdp in enumerate(curr_list):
                ...
                cn, mu, log_pi = tester_get_major_cn_prior(df_dict["major_cn"][idx],
                                                           df_dict["minor_cn"][idx], 2)
